...
class NotificationHelper {
  ...
  Future<void> showNotification(
    ...
    var channelId = "1";
    var channelName = "channel_notif_restaurant";
    var channelDescription = "Daily Notification";
    ...
    var titleNotification = "<b>$title</b>";
  ...
  void configureSelectNotificationSubject(String route) {
    selectNotificationSubject.stream.listen(
      (String payload) async {
        ...
        Navigation.intent(route: route, arguments: data);
      },
    );
  }
}
