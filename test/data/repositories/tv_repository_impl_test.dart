...
void main() {
  ...
  group('Get Movie Detail', () {
    final tId = 1;
    final tMovieResponse = TvDetailResponse(
      adult: false,
      backdropPath: 'backdropPath',
      genres: [GenreModel(id: 0, name: '')],
      id: 1,
      overview: 'overview',
      popularity: 1,
      ...
      lastEpisodeToAir: TEpisodeToAirResponse(),
      name: 'name',
      nextEpisodeToAir: TEpisodeToAirResponse(),
      numberOfEpisodes: 1,
      numberOfSeasons: 1,
  ...
  group('get watchlist status', () {
    test('should return watch status whether data is found', () async {
      // arrange
      final tId = 1;
      when(mockLocalDataSource.getMovieById(id: tId, isTv: true)).thenAnswer((_) async => null);
      // act
